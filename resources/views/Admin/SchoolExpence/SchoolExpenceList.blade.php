 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_title" style="margin-top: 20px;">
                                <br>
                          <h2 style="text-align: center; color: #37A3D3">School Expence List</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"><div id="datatable-responsive_filter" class="dataTables_filter"></div>
                                            ...
                                            <table  id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                  @php($sum = 0)
                                                @foreach($Schoolexpence as $Schoolexpences)
                                                   <tr>
                  <td>{{ $Schoolexpences->Date }}</td>
                  <td>{{ $Schoolexpences->Subject }}</td>
                   <td>{{ $Schoolexpences->Description }}</td>
                   <td>{{ $total = $Schoolexpences->Cost }}</td>
                  <td>

                    
              <a href="" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-edit"></i></a>
                                                              &nbsp;  &nbsp; 
       <a href="{{ url('/SchoolExpenceDelete/'.$Schoolexpences->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-times"></i></a>
