...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <form class="form-horizontal form-label-left" action="{{ url('/SaveSeatPlan') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                          ...
                          <option value="">Please Select Exm Type</option>
