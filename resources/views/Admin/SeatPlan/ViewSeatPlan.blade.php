 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <h2 style="color: greenyellow" align="center">{{ Session::get('Message') }}</h2>
                                ...
                                <div class="clearfix"><h3 class="text-center text-success"></h3></div>
                                 ...
                                 <h3 style="text-align: center;">Seat Plan</h3>
                                           ...
                                           <table  id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                       ...
                                                       <td>
                                             <a href="{{ url('/EditSeatPlan/'.$Seatplan->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-edit"></i></a>
                                                              &nbsp;  

                                                         <a href="{{ url('/PrintSeatPlan/'.$Seatplan->id) }}"data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-print"></i></a>

                                                              &nbsp; 
                                                           <a href="{{ url('/DeleteSeatPlan/'.$Seatplan->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-times"></i></a>
                                                       </td>
                                                   </tr>
