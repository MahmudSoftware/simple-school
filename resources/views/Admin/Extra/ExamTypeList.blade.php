 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_title" style="margin-top: 20px;">
                                <br>
                          <h2 style="text-align:">Exam Type List</h2>
                                        ...
                                        <div class="col-sm-6"><div id="datatable-responsive_filter" class="dataTables_filter"></div>
                                            ...
                                            <table  id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                       <td>{{ $Examtypes->Examtype }}</td>
                                                       <td>{{ $Examtypes->Description }}</td>
                                                       
                                                       <td>
    <a href="{{ url('/ExamtypeDelete/'.$Examtypes->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-times"></i></a> &nbsp; &nbsp;
                                                           <a href="http://localhost/AdarshaSchool/DeleteStudent/26" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-edit"></i></a>
                                                       </td>
                                                   </tr>
                                                   @endforeach
                                                </tbody>
