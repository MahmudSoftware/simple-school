...
<P class="heeee">Phone: 01911539893, 01792988787 &nbsp;  </P> <br>
 <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <form class="form-horizontal form-label-left" action="{{ url('/SaveExamType') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="x_panel tile">
                                            <div class="x_title">
                                                ...
                                                <div class="actions" align="right">
                                                    <a href="{{ url('/ExamTypeList') }}" class="btn btn-success" id="add"><i class=""></i>Exam Type List</a>
                                            ...
                                            <div class="x_content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" id="Examtype" name="Examtype" placeholder="Exam type" >
                                                    </div>
                                                </div>
                                       <br>
