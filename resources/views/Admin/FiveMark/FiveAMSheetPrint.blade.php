...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
 <ul class="nav navbar-right panel_toolbox">
  ...
  <h2 style="text-align: center;">Student's Marksheet</h2> <br>
...
<br>
 ...
 <div class="container">
    <div class="row">
      <div class="col-md-6">
        Father's Name: {{ $Playamarksheet->StudentsName }}
      </div>
      <div class="col-md-6">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        Mother's Name: {{ $Playamarksheet->MothersName }}
      </div>
      <div class="col-md-6">
        Section :  A
      </div>
...
<table class="table table-bordered">
      <thead>
        <tr>
          <th>Sl NO</th>
          <th>Subject</th>
          <th>1St Semister Exm</th>
          <th>2Nd Semister Exm</th>
          <th>3rd Semister Exm</th>
          <th>Final Exm</th>
          <th>Total</th>
          <th>Avarage</th>
