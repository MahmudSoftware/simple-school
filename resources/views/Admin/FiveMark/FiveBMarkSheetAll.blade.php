 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_title" style="margin-top: 20px;">
                                <br>
               <h2 style="text-align: center; color: #169F85">STD Five Section B List For Marksheet </h2>
  ...
  <h3 style="text-align: center; color: #30BAF8;"><b>{{ Session::get('Message') }}</b></h3>
                            ...
                            <div class="x_content" id="room_filter">
                                <div id="datatable-responsive_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    ...
                                    <li>
                                        <div class="actions">
             <a class="btn btn-success" href="{{ url('/FiveBIncMarkS/'.$Students->id) }}">Include Marksheet</a>
                                        </div>
                                    </li>
                                </ul> 
                                                       </td>
