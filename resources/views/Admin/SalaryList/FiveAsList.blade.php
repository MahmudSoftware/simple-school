...
<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                      ...
                      Student's   Salary Sheet / STD Five Section A
  <h6 style="text-align: center; color: #30BAF8;"><b>{{ Session::get('Message') }}</b></h6>
            ...
            <td> <a href="{{ url('/FiveASalaryDelete/'.$Salarys->id) }}"><i class="fa fa-trash"></i></a>
            <a href="{{ url('/FiveASalaryPrint/'.$Salarys->id) }}" target="blank"><i class="fa fa-print"></i></a>
