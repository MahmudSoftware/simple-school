...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
 <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <form class="form-horizontal form-label-left" action="{{ url('/SaveRoom') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="x_panel tile">
                                            ...
                                            <div class="x_content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="RoomNameNo">RoomName / No</label>
                                                        <input type="text" class="form-control" id="RoomNameNo" name="RoomNameNo" placeholder="RoomName / No" >
                                                    </div>
                                                </div>
                                       <br>
