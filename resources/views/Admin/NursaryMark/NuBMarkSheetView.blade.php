 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_title" style="margin-top: 20px;">
                                <br>
      <h2 style="text-align: center; color: #46BEF0">Nurasry Janani Marksheed List</h2>
  ...
  <h3 style="text-align: center; color: #30BAF8;"><b>{{ Session::get('Message') }}</b></h3>
                            ...
                            <div class="x_content" id="room_filter">
                              ...
                              <td>{{ $Playamarksheets->GrandAverage }}</td>
                                                       ...
                                                       <td>
             <a href="{{ url('NuBMSheetEdit/'.$Playamarksheets->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-edit"></i></a>
                                                        &nbsp; 
          <a href="{{ url('NuBMSheetDelete/'.$Playamarksheets->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-trash"></i></a>

                                                        &nbsp; 
                  <a href="{{ url('NuBMSheetPrint/'.$Playamarksheets->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-print"></i></a>
