...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
  <div class="heeee"><b> Student's Mark Sheet / Nursary Section Janani</b></div>
  
  <h3 style="text-align: center; color: #30BAF8;"><b>{{ Session::get('Message') }}</b></h3>
           
<form action="{{ url('/SaveNuBMarkSh') }}" method="POST">
     @csrf
<div class="row">
...
function PlayMarksix()
{
  ...
  var AvOfTotalmarkSix = TotalmarkSix/4;
   ...
   var FirstAverage = onExmon+onExTwo+onExThree+onExmFour+onExmFive+onExmSix;

   var FirstAverageAgricate = FirstAverage/6;
    document.getElementById('onExmTotal').value=FirstAverage;
    document.getElementById('onExmAverage').value=FirstAverageAgricate;

   var SecondAverage =twExmon+twExmTwo+twExmThree+twExmFour+twExmFive+twExmSix;
   var SwcondAverageAgricate = SecondAverage/6;
    document.getElementById('twExmTotal').value=SecondAverage;
    document.getElementById('twExmAverage').value=SwcondAverageAgricate;


    
var ThreeAverage =ThreExmon+ThreExTwo+ThreExmThree+ThreeExmFour+ThreExmFive+ThreExmSix;

   var ThreeAverageAgricate = ThreeAverage/6;
    document.getElementById('ThreExmTotal').value=ThreeAverage;
    document.getElementById('ThreExmAverage').value=ThreeAverageAgricate;



    var FinalAverage =FiExmon+FiExTwo+FiExmThree+FiExmFour+FiExmFive+FiExmSix;
   var FinalAverageAgricate = FinalAverage/6;
