...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
  <div class="heeee"><b> Student's Mark Sheet /STD Four Section A</b></div>
  
  <h3 style="text-align: center; color: #30BAF8;"><b>{{ Session::get('Message') }}</b></h3>
           
<form action="{{ url('/SaveFourAMarkSh') }}" method="POST">
     @csrf
<div class="row">
...
<div class="form-group">
 ...
 <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"  name="Subjectone"></td>
    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExmon" id="onExmon"></td>
  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmon" id="twExmon"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreExmon" id="ThreExmon"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExmon" style="width: 100px;" id="FiExmon"></td>
 ...
 <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"  name="SubjectTwo"></td>
    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExTwo" id="onExTwo"></td>
  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmTwo" id="twExmTwo"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreExTwo" id="ThreExTwo"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExTwo" style="width: 100px;" id="FiExTwo"></td>
 ...
 <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"  name="SubjectThree"></td>
    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExThree" id="onExThree"></td>
  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmThree" id="twExmThree"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreExmThree" id="ThreExmThree"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExmThree" style="width: 100px;" id="FiExmThree"></td>
 ...
 <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"  name="SubjectFour"></td>
    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExmFour" id="onExmFour"></td>
  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmFour" id="twExmFour"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreeExmFour" id="ThreeExmFour"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExmFour" style="width: 100px;" id="FiExmFour"></td>
 ...
 <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"  name="SubjectFive"></td>
    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExmFive" id="onExmFive"></td>
  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmFive" id="twExmFive"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreExmFive" id="ThreExmFive"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExmFive" style="width: 100px;" id="FiExmFive"></td>
 ...
 <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"  name="SubjectSix"></td>
    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExmSix" id="onExmSix"></td>
  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmSix" id="twExmSix"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreExmSix" id="ThreExmSix"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExmSix" style="width: 100px;" id="FiExmSix"></td>
  

    <td><input type="text" class="rrrrr" name="TotalSix" readonly="" id="TotalSix"></td>
    <td><input type="text" class="rrrrr" name="AvgSix" readonly="" id="AvgSix"></td>
 ...
 <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"  name="SubjectSv"></td>
    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExmSv" id="onExmSv"></td>
  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmSv" id="twExmSv"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreExmSv" id="ThreExmSv"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExmSv" style="width: 100px;" id="FiExmSv"></td>
  

    <td><input type="text" class="rrrrr" name="TotalSv" readonly="" id="TotalSv"></td>
    <td><input type="text" class="rrrrr" name="AvgSv" readonly="" id="AvgSv"></td>
 ...
 <td><input type="text" value="Total Mark = " onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"></td>

    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExmTotal" id="onExmTotal"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmTotal" id="twExmTotal"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreExmTotal" id="ThreExmTotal"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExmTotal" style="width: 100px;" id="FiExmTotal"></td>
 ...
 <td><input type="text" value="Average Mark = " onkeyup="FourAMark()" class="rrrrr" style="width: 200px;"></td>

    <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="onExmAverage" id="onExmAverage"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="twExmAverage" id="twExmAverage"></td>

  <td><input type="text" onkeyup="FourAMark()" class="rrrrr" style="width: 100px;" name="ThreExmAverage" id="ThreExmAverage"></td>

    <td><input type="text" class="rrrrr" onkeyup="FourAMark()" name="FiExmAverage" style="width: 100px;" id="FiExmAverage"></td>
