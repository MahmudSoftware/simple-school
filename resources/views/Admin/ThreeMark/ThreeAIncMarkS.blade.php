...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
  <div class="heeee"><b> Student's Mark Sheet / STD Three Section A</b></div>
  
  <h3 style="text-align: center; color: #30BAF8;"><b>{{ Session::get('Message') }}</b></h3>
           
<form action="{{ url('/SaveThreeAMarkSh') }}" method="POST">
     @csrf
<div class="row">
...
<div class="form-group">
 ...
 <td><input type="text" onkeyup="PlayMarksix()" class="rrrrr" style="width: 200px;"  name="SubjectSix"></td>
    <td><input type="text" onkeyup="PlayMarksix()" class="rrrrr" style="width: 100px;" name="onExmSix" id="onExmSix"></td>
  <td><input type="text" onkeyup="PlayMarksix()" class="rrrrr" style="width: 100px;" name="twExmSix" id="twExmSix"></td>

  <td><input type="text" onkeyup="PlayMarksix()" class="rrrrr" style="width: 100px;" name="ThreExmSix" id="ThreExmSix"></td>

    <td><input type="text" class="rrrrr" onkeyup="PlayMarksix()" name="FiExmSix" style="width: 100px;" id="FiExmSix"></td>
 ...
 <td><input type="text" onkeyup="PlayMarksix()" class="rrrrr" style="width: 200px;"  name="SubjectSv"></td>
    <td><input type="text" onkeyup="PlayMarksix()" class="rrrrr" style="width: 100px;" name="onExmSv" id="onExmSv"></td>
  <td><input type="text" onkeyup="PlayMarksix()" class="rrrrr" style="width: 100px;" name="twExmSv" id="twExmSv"></td>

  <td><input type="text" onkeyup="PlayMarksix()" class="rrrrr" style="width: 100px;" name="ThreExmSv" id="ThreExmSv"></td>

    <td><input type="text" class="rrrrr" onkeyup="PlayMarksix()" name="FiExmSv" style="width: 100px;" id="FiExmSv"></td>
