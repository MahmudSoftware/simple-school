 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_title" style="margin-top: 20px;">
                                <br>
      <h2 style="text-align: center; color: #46BEF0">STD Three A Marksheed List</h2>
  ...
  <h3 style="text-align: center; color: #30BAF8;"><b>{{ Session::get('Message') }}</b></h3>
                            ...
                            <div class="x_content" id="room_filter">
                              ...
                              <td>{{ $Playamarksheets->GrandAverage }}</td>
                                                       ...
                                                       <td>
             <a href="{{ url('ThreeAMSheetEdit/'.$Playamarksheets->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-edit"></i></a>
                                                        &nbsp; 
          <a href="{{ url('ThreeAMSheetDelete/'.$Playamarksheets->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-trash"></i></a>

                                                        &nbsp; 
                  <a href="{{ url('ThreeAMSheetPrint/'.$Playamarksheets->id) }}" data-toggle="modal" id="editsect" data-section_id="1"><i class="fa fa-print"></i></a>
