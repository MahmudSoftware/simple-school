...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
 ...
 <ul class="nav navbar-right panel_toolbox">
  ...
  <h4 style="text-align: center;">STD Three Section A</h4> <br>
...
<table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row">7</th>
          <td>{{ $Playamarksheet->SubjectSv }}</td>
          <td>{{ $Playamarksheet->onExmSv }}</td>
          <td>{{ $Playamarksheet->twExmSv }}</td>
          <td>{{ $Playamarksheet->ThreExmSv }}</td>
          <td>{{ $Playamarksheet->FiExmSv }}</td>
          <td>{{ $Playamarksheet->TotalSv }}</td>
          <td>{{ $Playamarksheet->AvgSv }}</td>
        </tr>
