...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
  <div class="heeee"><b> Student's Fee / Play Section Koroby</b></div>
...
<div class="row">
  ...
  <div class="col-sm-6">Student's Name: &nbsp; &nbsp; &nbsp; &nbsp;
    <input type="text" class="bopo" value="{{ $PsbSalary->StudentsName }}" name="StudentsName" readonly="">
  </div>

 <div class="col-sm-6">Roll: &nbsp; &nbsp;
    <input type="text" class="bopo" value="{{ $PsbSalary->Roll }}" name="Roll" readonly="">
  </div>
...
<div class="row">
  ...
  <div class="col-sm-6">Student ID: &nbsp; &nbsp; &nbsp; &nbsp;
    <input type="text" class="bopo" value="{{ $PsbSalary->StudentID }}" name="StudentID" readonly="">
  </div>
  <div class="col-sm-6">Date : 

    <input type="text" class="bopo" value="<?php echo date('y-m-d') ?>" name="Date">
                                        ...
                                        <div class="col-sm-6"><div id="datatable-responsive_filter" class="dataTables_filter"></div>
                                            ...
                                            <table  id="datatable-responsive" class="table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                   ...
                                                   <tr>
                                                       <td class="smm">1</td>
                                                       <td>{{ $PsbSalary->Descriptionon }}</td>
                                                       <td>{{ $PsbSalary->UnitPriceon }}</td>
                                                       <td>{{ $PsbSalary->Quantityon }}</td>
                                                       <td>{{ $PsbSalary->TotalPriceon }}</td>
                                                   </tr>

                                                   <tr>
                                                       <td class="smm">2</td>
                                                       <td>{{ $PsbSalary->Descriptiontw }}</td>
                                                       <td>{{ $PsbSalary->Unittw }}</td>
                                                       <td>{{ $PsbSalary->Pricetw }}</td>
                                                       <td>{{ $PsbSalary->TotalPricetw }}</td>
                                                   </tr>

                                                   <tr>
                                                       <td class="smm">3</td>
                                                       <td>{{ $PsbSalary->Descriptionth }}</td>
                                                       <td>{{ $PsbSalary->UnitPriceth }}</td>
                                                       <td>{{ $PsbSalary->Quantityth }}</td>
                                                       <td>{{ $PsbSalary->Totalth }}</td>
                                                   </tr>

                                                   <tr>
                                                       <td class="smm">4</td>
                                                       <td>{{ $PsbSalary->Descriptionfo }}</td>
                                                       <td>{{ $PsbSalary->UnitPricefo }}</td>
                                                       <td>{{ $PsbSalary->Quantityfo }}</td>
                                                       <td>{{ $PsbSalary->Totalfo }}</td>
                                                   </tr>

                                                   <tr>
                                                       <td class="smm">5</td>
                                                       <td>{{ $PsbSalary->Descriptionfi }}</td>
                                                       <td>{{ $PsbSalary->UnitPricefi }}</td>
                                                       <td>{{ $PsbSalary->Quantityfi }}</td>
                                                       <td>{{ $PsbSalary->TotalFive }}</td>
                                                   </tr>
