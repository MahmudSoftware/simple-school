...
<form action="{{ url('/SavePlayBSalary') }}" method="POST">
     @csrf
<div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                  @foreach($PsbSalary as $PsbSalarys)
                                        <tr>
                                           
                                            <td>{{ $PsbSalarys->StudentsName }}</td>
                                            <td>{{ $PsbSalarys->Roll }}</td>
                                            <td>{{ $PsbSalarys->Descriptionon }}</td>
                                            <td>{{ $PsbSalarys->TotalCPrices }}</td>
            <td> <a href=" url('/PlayAPaySalaryDelete/'Salarys->id) "><i class="fa fa-trash"></i></a>
                                             
                                             
                                               
     <a href="url('/PlayAPaySalaryPrint/'Salarys->id) " target="blank"><i class="fa fa-print"></i></a>
