...
<P class="heeee">Phone: 01911539893, 01792984747 &nbsp;  </P> <br>
  <div class="heeee"><b> Student's Fee / Nursary Section Shovon</b></div>
  
  <h3 style="text-align: center; color: #30BAF8;"><b>{{ Session::get('Message') }}</b></h3>
           
<form action="{{ url('/SavePlayASalary') }}" method="POST">
     @csrf
<div class="row">
...
<div class="row">
  ...
  <div class="col-sm-6">Date : 
  	...
  	<input type="text" class="bopo" value="{{ $Student->created_at }}" name="Date" readonly="">
